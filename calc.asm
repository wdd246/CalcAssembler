	 ...
	 RST 3 ;wydruk z pamiÍci op1  
	 RST 5 ;DE <- nnnn(h) pierwszy operand  
DZIAL 	 LXI H,OPD ;h<-OPD WYBOR DZIALANIA  
	 RST 3 ;wydruk z pamieci opd  
	 RST 2 ;A<-nn(h)  
	 CPI '+' ;jezeli a=='+' z=1 jeøeli nie z=0  
	 JZ DODA ;z?==1 idü do dodawania  
	 CPI '-' ;jezeli a=='-' z=1 jeøeli nie z=0  
	 JZ ODEJ ;z?==1 idü do odejmowania  
	 CPI 'n' ;jezeli a=='n' z=1 jeøeli nie z=0  
	 JZ NEGA ;z?==1 idü do negacji  
	 CMC ;cy<-~cy jezeli niema to cy=1 wiec negujemy cy do 0  
	 JMP DZIAL ;øadne z powyzszych - wroc do wybory dzialania  
